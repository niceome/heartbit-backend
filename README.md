...
| 구분 | 지표 (Metric) | 목표 수치 (Target) | 기준 |
|------|---------------|---------------------|------|
| 처리량 | Max TPS | 10,000 ~ 20,000 | 비즈니스 트랜잭션 완료 기준 |
| 응답속도 | Latency (MTT) | 0.1s (100ms) 이내 | 사용자 체감 속도 극대화 |
| 처리능력 | Throughput | 최대 50,000 | 시스템 전체 처리 대역폭 |
